...
# Fix OPTIONAL MATCH - returns cartesian product instead of left join

## Objective

Fix OPTIONAL MATCH to use LEFT JOIN semantics instead of returning a cartesian product of all nodes.
...
-- Actual: 4 rows (cartesian product)
```
